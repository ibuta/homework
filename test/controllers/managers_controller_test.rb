...
class ManagersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create manager" do
    assert_difference('Manager.count') do
      post managers_url, params: { manager: {  ,: @manager. ,,  ,: @manager. ,,  : @manager. , name: @manager.name, position: @manager.position, serial_number: @manager.serial_number } }
    end
  ...
  test "should update manager" do
    patch manager_url(@manager), params: { manager: {  ,: @manager. ,,  ,: @manager. ,,  : @manager. , name: @manager.name, position: @manager.position, serial_number: @manager.serial_number } }
